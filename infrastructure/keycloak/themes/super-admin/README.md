# Super Admin Keycloak Theme

Custom Keycloak theme for the Super Admin Portal.
...
- 🔒 Consistent with Super Admin UI
- 👤 Customized for system administrators
...
This theme should be assigned to the Super Admin client in Keycloak:

1. Go to Keycloak Admin Console
2. Navigate to Clients → [super-admin-client]
3. Go to the "Settings" tab
4. Scroll to "Login settings"
5. Set "Login theme" to `super-admin`
6. Save
