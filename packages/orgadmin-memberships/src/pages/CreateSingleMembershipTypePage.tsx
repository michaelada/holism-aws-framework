/**
 * Create/Edit Single Membership Type Page
 * 
...
const CreateSingleMembershipTypePage: React.FC = () => {
    ...
    <LocalizationProvider dateAdapter={AdapterDateFns} adapterLocale={enGB}>
      <Box sx={{ p: 3 }}>
        <Typography variant="h4" gutterBottom>
          {isEditMode ? 'Edit Single Membership Type' : 'Create Single Membership Type'}
        </Typography>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText="Display name for this membership type (e.g., 'Adult Membership')"
                />
              </Grid>
...
export default CreateSingleMembershipTypePage;
